...
export default function Show() {
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-5 p-6 bg-gray-50 dark:bg-gray-900">
                ...
                <Table className="min-w-full text-left">
                    ...
                    { data.is_group_plan ?
                        <Table.Body className="divide-y">
                            {selectedState.department_ids.length > 0 ?
                                selectedState.department_ids.map((department, index) => (
                                    <Table.Row 
                                        key={index} 
                    ...
                    :
                        <Table.Body className="divide-y">
                            {selectedState.user_ids.length > 0 ?
                                selectedState.user_ids.map((user, index) => (
                                    <Table.Row 
                                        key={index} 
                                        className="bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700"
                                    >
