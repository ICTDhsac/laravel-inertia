...
export default function Layout({ children }) {
    ...
    return (
        <div className="container-fluid">
            ...
            <div>
                {/* Side Navigation Bar */}
                <aside className={`fixed flex flex-col pt-20 h-screen border-r border-neutral-500 bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-100 p-6 space-y-6 transition-all duration-300 ${isCollapsed ? 'min-w-20' : 'min-w-64'} `}>
